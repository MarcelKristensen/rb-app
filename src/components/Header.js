  ...
  return (
    <>
      <Box
        ...
        <div>
          <Button onClick={handleOpen}>Login <img src={require('../icons/login.png')} alt='login'></img></Button>
          <Modal
          ...
          >
            ...
            <Box sx={style}>
                ...
                <small>Har du ikke en bruger? <Link to="/registrering">Opret her</Link></small>
                </Box>
                </Box>
            </Fade>
          </Modal>
