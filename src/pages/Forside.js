        ...
        >
          ...
          >
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-nike.png")}
                  width={"90%"}
                  alt="Sponsor-nike"
                ></img>
              </a>
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-bauhaus.png")}
                  width={"90%"}
                  alt="Sponsor-bauhaus"
                ></img>
              </a>
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-home.png")}
                  width={"90%"}
                  alt="Sponsor-home"
                ></img>
              </a>
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-ok.png")}
                  width={"90%"}
                  alt="Sponsor-ok"
                ></img>
              </a>
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-puma.png")}
                  width={"90%"}
                  alt="Sponsor-puma"
                ></img>
              </a>
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-spar-nord.png")}
                  width={"90%"}
            ...
            <Grid item xs={3}>
              <a href="/#">
                <img
                  src={require("../images/sponsor-sport24.png")}
                  width={"90%"}
                  alt="Sponsor-home"
                ></img>
              </a>
